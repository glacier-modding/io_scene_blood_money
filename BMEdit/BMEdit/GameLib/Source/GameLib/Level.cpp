...
namespace gamelib
{
	...
	bool Level::loadLevelProperties()
	{
		...
		if (!reader.parse(prpFileBuffer, prpFileSize))
		{
			return false;
		}
	...
	bool Level::loadLevelScene()
	{
		...
		if (!reader.parse(&m_sceneProperties.header, gmsFileBuffer, gmsFileSize, bufFileBuffer, bufFileSize))
		{
			return false;
		}
	...
	bool Level::loadLevelPrimitives()
	{
		...
		if (!reader.read(Span(prmFileBuffer, prmFileSize)))
		{
			return false;
		}
